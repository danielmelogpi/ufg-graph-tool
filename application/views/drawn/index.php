...
<html class="no-js"> <!--<![endif]-->
	...
	echo script_tag("assets/js/animations.js");
	echo script_tag("assets/js/objects.js");
	echo script_tag("assets/js/initialize.js");

	echo script_tag("assets/js/general-functions.js");
	echo script_tag("assets/js/controls.js");
	echo script_tag("assets/js/attr-panel.js");
	echo script_tag("assets/js/colpick.js");
	?>
	</body>
</html>
